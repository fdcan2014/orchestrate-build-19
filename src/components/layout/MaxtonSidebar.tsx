...
const menuItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Tickets", url: "/suporte/tickets" },
      { title: "Chat ao Vivo", url: "/suporte/chat" },
      { title: "Clientes", url: "/suporte/clientes" },
      { title: "Peças", url: "/suporte/pecas" },
      { title: "Base de Conhecimento", url: "/suporte/base-conhecimento" },
      { title: "Métricas", url: "/suporte/metricas" },
